...
$req->execute(array(
    ...
    //Récupération id pour lien mail

      $id_projet="";

      $req_mail = $bdd->query('SELECT * FROM fiches WHERE titre_projet="'.$titre_proj.'"');
      ...
      $req_mail->closeCursor();
         ...
         $to = 'camille.adouard@adeccogroup.com, veronique.milsant@adeccogroup.com, bruno.moyne@adeccogroup.com'; 
        ...
        $message2 .= '<p> Votre téléphone: '.$tel_pil.' </p>';
        $message2 .= '<p> Lien vers votre projet: http://www.camilleadouard/FichesProjetAdecco/displayfiche.php?ficheid='.$id_projet.' </p><body></html>';
